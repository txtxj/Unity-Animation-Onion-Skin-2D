...
namespace Utils.Citrine.AnimationOnionSkin
{
    public class AnimationOnionStage : PreviewSceneStage
    {
        ...
        private void OnSceneGUI(SceneView sceneView)
        {
            ...
            Alpha = EditorGUI.Slider(new Rect(50, 20, 200, 20), "Alpha Factor(*)", Alpha, 0, 1);

            Step = EditorGUI.IntField(new Rect(50, 45, 200, 20), "Frame Step", Step);

            AlwaysRepaint = EditorGUI.Toggle(new Rect(50, 70, 200, 20), "Always Repaint", AlwaysRepaint);

            FreelyDrag = !EditorGUI.Toggle(new Rect(50, 95, 200, 20), "Fixed Position", !FreelyDrag);
            ...
            else if (GUI.Button(new Rect(50, 120, 200, 15), "Reset Position") && _mainGameObject != null)
            {
                FreelyDrag = false;
